...
insert into mahsulotlar (mahsulot_nomi, narx) values ("smartfon", 1500000.00),
("noutbuk", 4500000.00),
("televizor", 2800000.00);
select * from mahsulotlar;
select * from mahsulotlar where narx > 2000000;
...
create table xodimlar (ID int auto_increment primary key, ism varchar(50), lavozim varchar(50), maosh decimal(10,2));
